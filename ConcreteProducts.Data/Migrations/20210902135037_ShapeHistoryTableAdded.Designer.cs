...
namespace ConcreteProducts.Data.Migrations
{
    ...
    [Migration("20210902135037_ShapeHistoryTableAdded")]
    partial class ShapeHistoryTableAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConcreteProducts.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConcreteProducts.Data.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConcreteProducts.Data.Models.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConcreteProducts.Data.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConcreteProducts.Data.Models.Product", b =>
                {
                    b.HasOne("ConcreteProducts.Data.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ConcreteProducts.Data.Models.ProductColor", b =>
                {
                    b.HasOne("ConcreteProducts.Data.Models.Color", "Color")
                        .WithMany("ProductColors")
                        .HasForeignKey("ColorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ConcreteProducts.Data.Models.Product", "Product")
                        .WithMany("ProductColors")
            ...
            modelBuilder.Entity("ConcreteProducts.Data.Models.Shape", b =>
                {
                    b.HasOne("ConcreteProducts.Data.Models.Warehouse", "Warehouse")
                        .WithMany("Shapes")
